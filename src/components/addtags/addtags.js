        ...
        <div>
            {editTag ? (
                <div className="modal-edit-tag-close-container" onClick={(e) => closeEditTag(e)}>
                    ...
                    <div style={{ top: `${possition}px` }} className="modal-edit-tag-content-container">
                        Название
                        <input
                            value={newName}
                            onChange={(e) => {
                        ...
                        <div className="edit-tag-buttons-container">
                            <input type="button" className="edit-tag-button" value="Сохранить" onClick={() => saveEditTag()} />
                            {editTag.id ? <input type="button" className="edit-tag-button" value="Удалить" onClick={() => setIsRemovable(true)} /> : ""}
                        </div>
                    </div>
                </div>
            ) : (
            ...
            {tags
                ...
                : ""}
            {cardId ? "" : <input value="Добавить метку" className="tag-add__btn" onClick={(e) => addTag(e)} type="button" />}
        </div>
    );
}
